...
#ifndef UTILS_INCLUDE_LEVEL_ZERO_UTILS_HPP_
#define UTILS_INCLUDE_LEVEL_ZERO_UTILS_HPP_

#include <string.h>
#ifdef USE_LOCAL_LEVEL_ZERO
...
class zeEventPool {
 public:
  ...
  void create_event(ze_event_handle_t* event, ze_event_scope_flags_t signal = 0, ze_event_scope_flags_t wait = 0);
...
#endif  // UTILS_INCLUDE_LEVEL_ZERO_UTILS_HPP_
